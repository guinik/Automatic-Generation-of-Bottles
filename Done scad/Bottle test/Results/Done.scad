// Generated by SolidPython 1.1.3 on 2023-04-08 04:54:24
$fn=64;
...
union() {
	...
	translate(v = [0, 0, 5.9500000000]) {
		difference() {
			cylinder(h = 0.7500000000, r1 = 1.4000000000, r2 = 0.4100000000);
			cylinder(h = 0.7500000000, r1 = 1.2900000000, r2 = 0.3100000000);
		}
	}
}